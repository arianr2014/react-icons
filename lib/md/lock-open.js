...
var MdLockOpen = function (_React$Component) {
    ...
    function MdLockOpen() {
        ...
        return _possibleConstructorReturn(this, (MdLockOpen.__proto__ || Object.getPrototypeOf(MdLockOpen)).apply(this, arguments));
    }
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'g',
                    null,
                    React.createElement('path', { d: 'm30 33.4v-16.8h-20v16.8h20z m0-20c1.8 0 3.4 1.4 3.4 3.2v16.8c0 1.8-1.6 3.2-3.4 3.2h-20c-1.8 0-3.4-1.4-3.4-3.2v-16.8c0-1.8 1.6-3.2 3.4-3.2h15.2v-3.4c0-2.8-2.4-5.2-5.2-5.2s-5.2 2.4-5.2 5.2h-3.2c0-4.6 3.8-8.4 8.4-8.4s8.4 3.8 8.4 8.4v3.4h1.6z m-10 15c-1.8 0-3.4-1.6-3.4-3.4s1.6-3.4 3.4-3.4 3.4 1.6 3.4 3.4-1.6 3.4-3.4 3.4z' })
                )
            );
        }
    }]);
