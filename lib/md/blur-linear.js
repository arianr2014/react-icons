...
var MdBlurLinear = function (_React$Component) {
    _inherits(MdBlurLinear, _React$Component);

    function MdBlurLinear() {
        _classCallCheck(this, MdBlurLinear);

        return _possibleConstructorReturn(this, (MdBlurLinear.__proto__ || Object.getPrototypeOf(MdBlurLinear)).apply(this, arguments));
    }

    _createClass(MdBlurLinear, [{
        key: 'render',
