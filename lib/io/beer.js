...
var IoBeer = function (_React$Component) {
    _inherits(IoBeer, _React$Component);

    function IoBeer() {
        _classCallCheck(this, IoBeer);

        return _possibleConstructorReturn(this, (IoBeer.__proto__ || Object.getPrototypeOf(IoBeer)).apply(this, arguments));
    }
