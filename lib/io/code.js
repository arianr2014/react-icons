...
var IoCode = function (_React$Component) {
    _inherits(IoCode, _React$Component);

    function IoCode() {
        _classCallCheck(this, IoCode);

        return _possibleConstructorReturn(this, (IoCode.__proto__ || Object.getPrototypeOf(IoCode)).apply(this, arguments));
    }
