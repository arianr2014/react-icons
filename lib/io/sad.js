...
var IoSad = function (_React$Component) {
    _inherits(IoSad, _React$Component);

    function IoSad() {
        _classCallCheck(this, IoSad);

        return _possibleConstructorReturn(this, (IoSad.__proto__ || Object.getPrototypeOf(IoSad)).apply(this, arguments));
    }
