...
var FaBuildingO = function (_React$Component) {
    _inherits(FaBuildingO, _React$Component);

    function FaBuildingO() {
        _classCallCheck(this, FaBuildingO);

        return _possibleConstructorReturn(this, (FaBuildingO.__proto__ || Object.getPrototypeOf(FaBuildingO)).apply(this, arguments));
    }

    _createClass(FaBuildingO, [{
        key: 'render',
