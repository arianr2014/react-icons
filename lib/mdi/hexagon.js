...
var MdiHexagon = function (_React$Component) {
    _inherits(MdiHexagon, _React$Component);

    function MdiHexagon() {
        _classCallCheck(this, MdiHexagon);

        return _possibleConstructorReturn(this, (MdiHexagon.__proto__ || Object.getPrototypeOf(MdiHexagon)).apply(this, arguments));
    }

    _createClass(MdiHexagon, [{
        key: 'render',
