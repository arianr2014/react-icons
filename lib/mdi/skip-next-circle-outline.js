...
var MdiSkipNextCircleOutline = function (_React$Component) {
    _inherits(MdiSkipNextCircleOutline, _React$Component);

    function MdiSkipNextCircleOutline() {
        _classCallCheck(this, MdiSkipNextCircleOutline);

        return _possibleConstructorReturn(this, (MdiSkipNextCircleOutline.__proto__ || Object.getPrototypeOf(MdiSkipNextCircleOutline)).apply(this, arguments));
    }

    _createClass(MdiSkipNextCircleOutline, [{
        key: 'render',
    ...
    return MdiSkipNextCircleOutline;
}(React.Component);
