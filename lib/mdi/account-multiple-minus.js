...
var MdiAccountMultipleMinus = function (_React$Component) {
    _inherits(MdiAccountMultipleMinus, _React$Component);

    function MdiAccountMultipleMinus() {
        _classCallCheck(this, MdiAccountMultipleMinus);

        return _possibleConstructorReturn(this, (MdiAccountMultipleMinus.__proto__ || Object.getPrototypeOf(MdiAccountMultipleMinus)).apply(this, arguments));
    }

    _createClass(MdiAccountMultipleMinus, [{
        key: 'render',
    ...
    return MdiAccountMultipleMinus;
}(React.Component);
