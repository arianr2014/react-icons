...
var MdiPhonePlus = function (_React$Component) {
    _inherits(MdiPhonePlus, _React$Component);

    function MdiPhonePlus() {
        _classCallCheck(this, MdiPhonePlus);

        return _possibleConstructorReturn(this, (MdiPhonePlus.__proto__ || Object.getPrototypeOf(MdiPhonePlus)).apply(this, arguments));
    }

    _createClass(MdiPhonePlus, [{
        key: 'render',
