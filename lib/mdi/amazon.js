...
var MdiAmazon = function (_React$Component) {
    _inherits(MdiAmazon, _React$Component);

    function MdiAmazon() {
        _classCallCheck(this, MdiAmazon);

        return _possibleConstructorReturn(this, (MdiAmazon.__proto__ || Object.getPrototypeOf(MdiAmazon)).apply(this, arguments));
    }

    _createClass(MdiAmazon, [{
        key: 'render',
