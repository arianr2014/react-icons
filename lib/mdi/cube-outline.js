...
var MdiCubeOutline = function (_React$Component) {
    _inherits(MdiCubeOutline, _React$Component);

    function MdiCubeOutline() {
        _classCallCheck(this, MdiCubeOutline);

        return _possibleConstructorReturn(this, (MdiCubeOutline.__proto__ || Object.getPrototypeOf(MdiCubeOutline)).apply(this, arguments));
    }

    _createClass(MdiCubeOutline, [{
        key: 'render',
...
exports.default = MdiCubeOutline;
