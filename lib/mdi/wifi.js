...
var MdiWifi = function (_React$Component) {
    _inherits(MdiWifi, _React$Component);

    function MdiWifi() {
        _classCallCheck(this, MdiWifi);

        return _possibleConstructorReturn(this, (MdiWifi.__proto__ || Object.getPrototypeOf(MdiWifi)).apply(this, arguments));
    }

    _createClass(MdiWifi, [{
        key: 'render',
