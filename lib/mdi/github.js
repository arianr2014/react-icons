...
var MdiGithub = function (_React$Component) {
    _inherits(MdiGithub, _React$Component);

    function MdiGithub() {
        _classCallCheck(this, MdiGithub);

        return _possibleConstructorReturn(this, (MdiGithub.__proto__ || Object.getPrototypeOf(MdiGithub)).apply(this, arguments));
    }

    _createClass(MdiGithub, [{
        key: 'render',
