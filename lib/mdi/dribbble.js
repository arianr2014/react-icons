...
var MdiDribbble = function (_React$Component) {
    _inherits(MdiDribbble, _React$Component);

    function MdiDribbble() {
        _classCallCheck(this, MdiDribbble);

        return _possibleConstructorReturn(this, (MdiDribbble.__proto__ || Object.getPrototypeOf(MdiDribbble)).apply(this, arguments));
    }

    _createClass(MdiDribbble, [{
        key: 'render',
