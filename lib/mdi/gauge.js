...
var MdiGauge = function (_React$Component) {
    _inherits(MdiGauge, _React$Component);

    function MdiGauge() {
        _classCallCheck(this, MdiGauge);

        return _possibleConstructorReturn(this, (MdiGauge.__proto__ || Object.getPrototypeOf(MdiGauge)).apply(this, arguments));
    }

    _createClass(MdiGauge, [{
        key: 'render',
