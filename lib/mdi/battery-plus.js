...
var MdiBatteryPlus = function (_React$Component) {
    _inherits(MdiBatteryPlus, _React$Component);

    function MdiBatteryPlus() {
        _classCallCheck(this, MdiBatteryPlus);

        return _possibleConstructorReturn(this, (MdiBatteryPlus.__proto__ || Object.getPrototypeOf(MdiBatteryPlus)).apply(this, arguments));
    }

    _createClass(MdiBatteryPlus, [{
        key: 'render',
