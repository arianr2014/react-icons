...
var MdiDatabaseMinus = function (_React$Component) {
    _inherits(MdiDatabaseMinus, _React$Component);

    function MdiDatabaseMinus() {
        _classCallCheck(this, MdiDatabaseMinus);

        return _possibleConstructorReturn(this, (MdiDatabaseMinus.__proto__ || Object.getPrototypeOf(MdiDatabaseMinus)).apply(this, arguments));
    }

    _createClass(MdiDatabaseMinus, [{
        key: 'render',
