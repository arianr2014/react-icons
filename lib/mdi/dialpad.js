...
var MdiDialpad = function (_React$Component) {
    _inherits(MdiDialpad, _React$Component);

    function MdiDialpad() {
        _classCallCheck(this, MdiDialpad);

        return _possibleConstructorReturn(this, (MdiDialpad.__proto__ || Object.getPrototypeOf(MdiDialpad)).apply(this, arguments));
    }

    _createClass(MdiDialpad, [{
        key: 'render',
