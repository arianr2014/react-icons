...
var MdiTruck = function (_React$Component) {
    _inherits(MdiTruck, _React$Component);

    function MdiTruck() {
        _classCallCheck(this, MdiTruck);

        return _possibleConstructorReturn(this, (MdiTruck.__proto__ || Object.getPrototypeOf(MdiTruck)).apply(this, arguments));
    }

    _createClass(MdiTruck, [{
        key: 'render',
