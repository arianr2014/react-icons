...
var MdiBlurOff = function (_React$Component) {
    _inherits(MdiBlurOff, _React$Component);

    function MdiBlurOff() {
        _classCallCheck(this, MdiBlurOff);

        return _possibleConstructorReturn(this, (MdiBlurOff.__proto__ || Object.getPrototypeOf(MdiBlurOff)).apply(this, arguments));
    }

    _createClass(MdiBlurOff, [{
        key: 'render',
