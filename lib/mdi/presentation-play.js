...
var MdiPresentationPlay = function (_React$Component) {
    _inherits(MdiPresentationPlay, _React$Component);

    function MdiPresentationPlay() {
        _classCallCheck(this, MdiPresentationPlay);

        return _possibleConstructorReturn(this, (MdiPresentationPlay.__proto__ || Object.getPrototypeOf(MdiPresentationPlay)).apply(this, arguments));
    }

    _createClass(MdiPresentationPlay, [{
        key: 'render',
