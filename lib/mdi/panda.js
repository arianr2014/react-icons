...
var MdiPanda = function (_React$Component) {
    _inherits(MdiPanda, _React$Component);

    function MdiPanda() {
        _classCallCheck(this, MdiPanda);

        return _possibleConstructorReturn(this, (MdiPanda.__proto__ || Object.getPrototypeOf(MdiPanda)).apply(this, arguments));
    }

    _createClass(MdiPanda, [{
        key: 'render',
