...
var MdiWalletGiftcard = function (_React$Component) {
    _inherits(MdiWalletGiftcard, _React$Component);

    function MdiWalletGiftcard() {
        _classCallCheck(this, MdiWalletGiftcard);

        return _possibleConstructorReturn(this, (MdiWalletGiftcard.__proto__ || Object.getPrototypeOf(MdiWalletGiftcard)).apply(this, arguments));
    }

    _createClass(MdiWalletGiftcard, [{
        key: 'render',
