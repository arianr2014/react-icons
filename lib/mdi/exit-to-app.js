...
var MdiExitToApp = function (_React$Component) {
    _inherits(MdiExitToApp, _React$Component);

    function MdiExitToApp() {
        _classCallCheck(this, MdiExitToApp);

        return _possibleConstructorReturn(this, (MdiExitToApp.__proto__ || Object.getPrototypeOf(MdiExitToApp)).apply(this, arguments));
    }

    _createClass(MdiExitToApp, [{
        key: 'render',
