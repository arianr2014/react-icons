...
var MdiVideo = function (_React$Component) {
    _inherits(MdiVideo, _React$Component);

    function MdiVideo() {
        _classCallCheck(this, MdiVideo);

        return _possibleConstructorReturn(this, (MdiVideo.__proto__ || Object.getPrototypeOf(MdiVideo)).apply(this, arguments));
    }

    _createClass(MdiVideo, [{
        key: 'render',
