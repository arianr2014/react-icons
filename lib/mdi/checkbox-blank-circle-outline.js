...
var MdiCheckboxBlankCircleOutline = function (_React$Component) {
    _inherits(MdiCheckboxBlankCircleOutline, _React$Component);

    function MdiCheckboxBlankCircleOutline() {
        _classCallCheck(this, MdiCheckboxBlankCircleOutline);

        return _possibleConstructorReturn(this, (MdiCheckboxBlankCircleOutline.__proto__ || Object.getPrototypeOf(MdiCheckboxBlankCircleOutline)).apply(this, arguments));
    }

    _createClass(MdiCheckboxBlankCircleOutline, [{
        key: 'render',
