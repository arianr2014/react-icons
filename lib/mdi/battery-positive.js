...
var MdiBatteryPositive = function (_React$Component) {
    _inherits(MdiBatteryPositive, _React$Component);

    function MdiBatteryPositive() {
        _classCallCheck(this, MdiBatteryPositive);

        return _possibleConstructorReturn(this, (MdiBatteryPositive.__proto__ || Object.getPrototypeOf(MdiBatteryPositive)).apply(this, arguments));
    }

    _createClass(MdiBatteryPositive, [{
        key: 'render',
