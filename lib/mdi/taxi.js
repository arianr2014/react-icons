...
var MdiTaxi = function (_React$Component) {
    _inherits(MdiTaxi, _React$Component);

    function MdiTaxi() {
        _classCallCheck(this, MdiTaxi);

        return _possibleConstructorReturn(this, (MdiTaxi.__proto__ || Object.getPrototypeOf(MdiTaxi)).apply(this, arguments));
    }

    _createClass(MdiTaxi, [{
        key: 'render',
