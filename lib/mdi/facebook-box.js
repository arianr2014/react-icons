...
var MdiFacebookBox = function (_React$Component) {
    _inherits(MdiFacebookBox, _React$Component);

    function MdiFacebookBox() {
        _classCallCheck(this, MdiFacebookBox);

        return _possibleConstructorReturn(this, (MdiFacebookBox.__proto__ || Object.getPrototypeOf(MdiFacebookBox)).apply(this, arguments));
    }

    _createClass(MdiFacebookBox, [{
        key: 'render',
