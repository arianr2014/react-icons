...
var MdiAppleSafari = function (_React$Component) {
    _inherits(MdiAppleSafari, _React$Component);

    function MdiAppleSafari() {
        _classCallCheck(this, MdiAppleSafari);

        return _possibleConstructorReturn(this, (MdiAppleSafari.__proto__ || Object.getPrototypeOf(MdiAppleSafari)).apply(this, arguments));
    }

    _createClass(MdiAppleSafari, [{
        key: 'render',
...
exports.default = MdiAppleSafari;
