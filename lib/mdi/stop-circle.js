...
var MdiStopCircle = function (_React$Component) {
    _inherits(MdiStopCircle, _React$Component);

    function MdiStopCircle() {
        _classCallCheck(this, MdiStopCircle);

        return _possibleConstructorReturn(this, (MdiStopCircle.__proto__ || Object.getPrototypeOf(MdiStopCircle)).apply(this, arguments));
    }

    _createClass(MdiStopCircle, [{
        key: 'render',
