...
var MdiCube = function (_React$Component) {
    _inherits(MdiCube, _React$Component);

    function MdiCube() {
        _classCallCheck(this, MdiCube);

        return _possibleConstructorReturn(this, (MdiCube.__proto__ || Object.getPrototypeOf(MdiCube)).apply(this, arguments));
    }

    _createClass(MdiCube, [{
        key: 'render',
