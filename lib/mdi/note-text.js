...
var MdiNoteText = function (_React$Component) {
    _inherits(MdiNoteText, _React$Component);

    function MdiNoteText() {
        _classCallCheck(this, MdiNoteText);

        return _possibleConstructorReturn(this, (MdiNoteText.__proto__ || Object.getPrototypeOf(MdiNoteText)).apply(this, arguments));
    }

    _createClass(MdiNoteText, [{
        key: 'render',
