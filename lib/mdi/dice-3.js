...
var MdiDice3 = function (_React$Component) {
    _inherits(MdiDice3, _React$Component);

    function MdiDice3() {
        _classCallCheck(this, MdiDice3);

        return _possibleConstructorReturn(this, (MdiDice3.__proto__ || Object.getPrototypeOf(MdiDice3)).apply(this, arguments));
    }

    _createClass(MdiDice3, [{
        key: 'render',
