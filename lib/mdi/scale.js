...
var MdiScale = function (_React$Component) {
    _inherits(MdiScale, _React$Component);

    function MdiScale() {
        _classCallCheck(this, MdiScale);

        return _possibleConstructorReturn(this, (MdiScale.__proto__ || Object.getPrototypeOf(MdiScale)).apply(this, arguments));
    }

    _createClass(MdiScale, [{
        key: 'render',
