...
var MdiCloudCheck = function (_React$Component) {
    _inherits(MdiCloudCheck, _React$Component);

    function MdiCloudCheck() {
        _classCallCheck(this, MdiCloudCheck);

        return _possibleConstructorReturn(this, (MdiCloudCheck.__proto__ || Object.getPrototypeOf(MdiCloudCheck)).apply(this, arguments));
    }

    _createClass(MdiCloudCheck, [{
        key: 'render',
