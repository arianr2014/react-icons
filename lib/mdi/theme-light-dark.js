...
var MdiThemeLightDark = function (_React$Component) {
    _inherits(MdiThemeLightDark, _React$Component);

    function MdiThemeLightDark() {
        _classCallCheck(this, MdiThemeLightDark);

        return _possibleConstructorReturn(this, (MdiThemeLightDark.__proto__ || Object.getPrototypeOf(MdiThemeLightDark)).apply(this, arguments));
    }

    _createClass(MdiThemeLightDark, [{
        key: 'render',
...
exports.default = MdiThemeLightDark;
