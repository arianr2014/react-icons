...
var MdiPlusNetwork = function (_React$Component) {
    _inherits(MdiPlusNetwork, _React$Component);

    function MdiPlusNetwork() {
        _classCallCheck(this, MdiPlusNetwork);

        return _possibleConstructorReturn(this, (MdiPlusNetwork.__proto__ || Object.getPrototypeOf(MdiPlusNetwork)).apply(this, arguments));
    }

    _createClass(MdiPlusNetwork, [{
        key: 'render',
