...
var MdiComment = function (_React$Component) {
    _inherits(MdiComment, _React$Component);

    function MdiComment() {
        _classCallCheck(this, MdiComment);

        return _possibleConstructorReturn(this, (MdiComment.__proto__ || Object.getPrototypeOf(MdiComment)).apply(this, arguments));
    }

    _createClass(MdiComment, [{
        key: 'render',
