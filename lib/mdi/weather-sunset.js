...
var MdiWeatherSunset = function (_React$Component) {
    _inherits(MdiWeatherSunset, _React$Component);

    function MdiWeatherSunset() {
        _classCallCheck(this, MdiWeatherSunset);

        return _possibleConstructorReturn(this, (MdiWeatherSunset.__proto__ || Object.getPrototypeOf(MdiWeatherSunset)).apply(this, arguments));
    }

    _createClass(MdiWeatherSunset, [{
        key: 'render',
...
exports.default = MdiWeatherSunset;
