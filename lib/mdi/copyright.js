...
var MdiCopyright = function (_React$Component) {
	_inherits(MdiCopyright, _React$Component);

	function MdiCopyright() {
		_classCallCheck(this, MdiCopyright);

		return _possibleConstructorReturn(this, (MdiCopyright.__proto__ || Object.getPrototypeOf(MdiCopyright)).apply(this, arguments));
	}

	_createClass(MdiCopyright, [{
		key: 'render',
