...
var MdiWheelchairAccessibility = function (_React$Component) {
    _inherits(MdiWheelchairAccessibility, _React$Component);

    function MdiWheelchairAccessibility() {
        _classCallCheck(this, MdiWheelchairAccessibility);

        return _possibleConstructorReturn(this, (MdiWheelchairAccessibility.__proto__ || Object.getPrototypeOf(MdiWheelchairAccessibility)).apply(this, arguments));
    }

    _createClass(MdiWheelchairAccessibility, [{
        key: 'render',
...
exports.default = MdiWheelchairAccessibility;
