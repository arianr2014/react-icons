...
var MdiPokeball = function (_React$Component) {
    _inherits(MdiPokeball, _React$Component);

    function MdiPokeball() {
        _classCallCheck(this, MdiPokeball);

        return _possibleConstructorReturn(this, (MdiPokeball.__proto__ || Object.getPrototypeOf(MdiPokeball)).apply(this, arguments));
    }

    _createClass(MdiPokeball, [{
        key: 'render',
