...
var MdiCheckboxMultipleBlankCircle = function (_React$Component) {
    _inherits(MdiCheckboxMultipleBlankCircle, _React$Component);

    function MdiCheckboxMultipleBlankCircle() {
        _classCallCheck(this, MdiCheckboxMultipleBlankCircle);

        return _possibleConstructorReturn(this, (MdiCheckboxMultipleBlankCircle.__proto__ || Object.getPrototypeOf(MdiCheckboxMultipleBlankCircle)).apply(this, arguments));
    }

    _createClass(MdiCheckboxMultipleBlankCircle, [{
        key: 'render',
    ...
    return MdiCheckboxMultipleBlankCircle;
}(React.Component);
