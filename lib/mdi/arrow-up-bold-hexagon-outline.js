...
var MdiArrowUpBoldHexagonOutline = function (_React$Component) {
    _inherits(MdiArrowUpBoldHexagonOutline, _React$Component);

    function MdiArrowUpBoldHexagonOutline() {
        _classCallCheck(this, MdiArrowUpBoldHexagonOutline);

        return _possibleConstructorReturn(this, (MdiArrowUpBoldHexagonOutline.__proto__ || Object.getPrototypeOf(MdiArrowUpBoldHexagonOutline)).apply(this, arguments));
    }

    _createClass(MdiArrowUpBoldHexagonOutline, [{
        key: 'render',
    ...
    return MdiArrowUpBoldHexagonOutline;
}(React.Component);
