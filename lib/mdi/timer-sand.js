...
var MdiTimerSand = function (_React$Component) {
    _inherits(MdiTimerSand, _React$Component);

    function MdiTimerSand() {
        _classCallCheck(this, MdiTimerSand);

        return _possibleConstructorReturn(this, (MdiTimerSand.__proto__ || Object.getPrototypeOf(MdiTimerSand)).apply(this, arguments));
    }

    _createClass(MdiTimerSand, [{
        key: 'render',
