...
var MdiWeatherHail = function (_React$Component) {
    _inherits(MdiWeatherHail, _React$Component);

    function MdiWeatherHail() {
        _classCallCheck(this, MdiWeatherHail);

        return _possibleConstructorReturn(this, (MdiWeatherHail.__proto__ || Object.getPrototypeOf(MdiWeatherHail)).apply(this, arguments));
    }

    _createClass(MdiWeatherHail, [{
        key: 'render',
...
exports.default = MdiWeatherHail;
